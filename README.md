...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    A meaningful way to write html.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
    display: inline does not adjust height and width.
    display: block will use up full width while display: inline uses as much width as needed.
...
5. Explain why git is valuable to a team of developers.
    Allows team collaboration on projects. You can work on separate branches without affected the master branch.
